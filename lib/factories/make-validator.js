...
const schemaOptionKeys = ['message', 'schema', 'use', 'required', 'type', 'length', 'enum', 'match', 'each', 'elements', 'path', 'typecast', 'validate']; /* eslint-disable no-param-reassign */
...
const makeValidator = exports.makeValidator = (0, _helpers.makeClassFactory)(_helpers.validatorClassName, classImpl);